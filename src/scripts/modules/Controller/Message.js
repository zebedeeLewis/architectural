...
exports.is_common = exports.is_initialize = exports.set_root_html_element_to = exports.get_root_html_element_from = exports.set_argv_to = exports.get_argv_from = exports.Initialize = exports.is_message_of_type = exports.create_factory = void 0;
...
function get_argv_from(model) {
    return model.get('argv', undefined);
}
exports.get_argv_from = get_argv_from;
function set_argv_to(newElement, model) {
    return model.set('argv', newElement);
}
exports.set_argv_to = set_argv_to;
